...
ActiveRecord::Schema.define(version: 20191127065203) do
  ...
  create_table "books_shops", force: :cascade do |t|
    ...
    t.datetime "created_at",                 null: false
    t.datetime "updated_at",                 null: false
    t.index ["book_id"], name: "index_books_shops_on_book_id", using: :btree
    t.index ["shop_id"], name: "index_books_shops_on_shop_id", using: :btree
  end
